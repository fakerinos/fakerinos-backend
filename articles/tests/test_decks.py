...
class TestDeckAPI(APITestCase):
    ...
    def setUp(self):
        ...
        # Articles
        self.article = mixer.blend(Article, headline='article1')
        self.article2 = mixer.blend(Article,headline='article2')
    ...
    def test_link_deck_to_articles(self):
        ...
        assert self.assertEqual(self.deck.articles.count(), 1)
