    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finished_decks', models.ManyToManyField(blank=True, related_name='finishers', to='articles.Deck')),
                ('interests', models.ManyToManyField(blank=True, related_name='interested_users', to='articles.Tag')),
                ('starred_decks', models.ManyToManyField(blank=True, related_name='starrers', to='articles.Deck')),
            ],
        ),
        migrations.AddField(
            model_name='user',
