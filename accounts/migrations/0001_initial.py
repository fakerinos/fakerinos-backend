    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.CharField(choices=[('X', 'Unknown'), ('KG', 'Kindergarten'), ('PR', 'Primary'), ('SE', 'Secondary'), ('UG', 'Undergraduate'), ('PG', 'Postgraduate'), ('PH', 'Doctorate')], default='SE', max_length=2)),
